...
import { getSessionConfig, requireAuth as sharedRequireAuth, isAuthenticated as sharedIsAuthenticated } from "../shared/auth.js";
...
/**
 * Hash a password using bcrypt (same as creator_tracking_server)
 */
...
/**
 * Verify a password against a bcrypt hash (same as creator_tracking_server)
 */
 ...
 */
app.post("/api/change-password", requireAuth, async (_req, res) => {
  try {
