...
import pumpIdl from "./idls/pumpfun/pump_0.1.0.json" with { type: "json" };
import pumpAmmIdl from "./idls/pumpAmm/pump_amm_0.1.0.json" with { type: "json" };
import raydiumLiquidityIdl from "./idls/raydiumLiquidity/raydium_liquidity_4.0.0.json" with { type: "json" };
import raydiumClmmIdl from "./idls/raydiumClmm/raydium_clmm_0.1.0.json" with { type: "json" };
import raydiumCPIdl from "./idls/raydiumCp/raydium_cp_0.2.0.json" with { type: "json" };
import raydiumLaunchpadIdl from "./idls/raydiumLaunchpad/raydium_launchpad_0.2.0.json" with { type: "json" };
import jupiterAggregatorIdl from "./idls/jupiterAggregator/jup_ag_0.1.0.json" with { type: "json" };
import meteoraDammV2Idl from "./idls/meteoraDammV2/meteora_dammV2.json" with { type: "json" };
import meteoraDBCIdl from "./idls/meteoraDBC/meteora_dbc_0.1.7.json" with { type: "json" };
import meteoraDLMMIdl from "./idls/meteoraDlmm/meteora_dlmm_0.10.1.json" with { type: "json" };
import orcaIdl from "./idls/orca/orca_whirlpool_0.3.6.json" with { type: "json" };
import pancakeSwapLiquidityIdl from "./idls/pancakeSwap/pancake_swap_0.1.0.json" with { type: "json" };
import goonfiIdl from "./idls/goonfi/goonfi_0.1.0.json" with { type: "json" };
